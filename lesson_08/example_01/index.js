...
// про способ объявления переменной var // и почему не стоит ее использовать 
// вы можете случайно проинициализировать переменную с тем же самым названием и перезаписать значение
